"""
Django settings for ibericagym project.
...
SECRET_KEY = 'django-insecure-uvg=63ly4m%4+hjz09(c)myzz_sekd)6(+9(hte!5y-h9hdznr'
...
WSGI_APPLICATION = 'ibericagym.wsgi.application'
